...
describe("Onchain Verify", function () {
  ...
  it("Fibonacci Verification", async function () {
    ...
    const result = await verifier.verify(seal, imageId, postStateDigest, journalHash);
    console.log(result);
  });

  it("Bonsai Test Verification", async function () {
    const [owner] = await ethers.getSigners();
    ...
    const journalHash = sha256("0x5818100a2105c60d4f73044fe09a9cb0ba9801a4f5775e79cbb8934b23caab653c7846705db9354810f597a10674ad845f1a11d31cdd54fa7ca011ebf45c67000000000040eb306043ba7f507c09693f6d68f07f50722b010000000142add52666c78960a219b157a1f4dbf806cbf703");
